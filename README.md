...
| `contact.html` | Huonville, mailto form to hello@brabazonpoint.com |
...
- Footer: **BRABAZONPOINT · Huonville, Tasmania · hello@brabazonpoint.com** and **AI services · Local builds**.
...
GitHub Pages serves `main` at `/`. Forms use `mailto:hello@brabazonpoint.com` until a real endpoint exists.
